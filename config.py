...
# Database
DATABASE_URL = "mongodb+srv://serotonin:F@6F4*2E&%8z$ZME@cluster0.rih7z.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"  # Replace with your actual database URL
